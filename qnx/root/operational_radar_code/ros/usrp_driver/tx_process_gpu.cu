...
void tx_process_gpu(
   ...
   if (debug) printf("calculating mixer freqs\n");
   ...
   if (debug) printf("allocating output sample memory\n");
   int16_t** rfvecptrs_d;
