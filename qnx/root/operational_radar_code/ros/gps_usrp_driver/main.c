...
//	clock_gettime(CLOCK_REALTIME, &start);
	...
	//Actually, disable synchronized generator, disable gps reference, disable daylight savings time
	  *((uint32_t*)(BASE1+0x118))=0x09000000; //0x9 to address x11B sets reference signal to 10 MPPS
	...
	// clear time compare event
	  ...
	  *((uint32_t*)(BASE1+0x12c))=0x02000e00;  // x12e: event trigger on external event, falling edge 
